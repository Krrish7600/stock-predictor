...
currency = st.selectbox("Select Currency", ["USD", "EUR", "GBP"], index=0)
prediction_period = st.selectbox("Select Prediction Period", ["1 Day", "7 Days", "1 Month", "6 Months"], index=0)
...
if st.button("Predict Stock Price"):
    ...
    if df is not None:
        ...
        fig_pred = go.Figure()
        fig_pred.add_trace(go.Scatter(x=pred_df["Time"], y=pred_df["Predicted Price"], mode="lines", name="Predicted Price", line=dict(color="red", dash="dot")))
